...
\item Los siguientes gráficos correspondes a los valores de la UF e IVP durante el año 2022. Interprete cada uno de los gráficos, haciendo énfasis en la ubicación del promedio respecto a la mediana, los posibles valores extremos, las concentraciones presentes en el gráfico y los posibles valores atípicos.
...
\item Los siguientes gráficos correspondes a los valores de la población de mujeres y hombres en el país en el periodo 2009 - 2022. Interprete cada uno de los gráficos, haciendo énfasis en la ubicación del promedio respecto a la mediana, los posibles valores extremos, las concentraciones presentens en el gráfico y los posibles valores atípicos.
