...
\item Los siguientes gráficos correspondes a los valores de la UF e IVP durante el año 2022. Para interpretar un gráfico de violín con caja y promedio se deben mencionar tres aspectos relevantes:
...
\item Los siguientes gráficos correspondes a los valores de la población de mujeres y hombres en el país en el periodo 2009 - 2022.Para interpretar un gráfico de violín con caja y promedio se deben mencionar tres aspectos relevantes:
